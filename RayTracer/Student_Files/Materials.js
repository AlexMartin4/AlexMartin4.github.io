...
var MATL_DEFAULT = 			 23;		
var MATL_EMIT_RED = 24;
var MATL_EMIT_GRN = 25;
var MATL_EMIT_BLU = 26;
var MATL_TRUNK = 27;
var MATL_MIRROR = 28;
...
// Constructor:  use these defaults:
	...
	this.absorb = .95;
	this.refraction = -1; //-1 for no transparency
...
// This function DOES NOT CHANGE values of any of its uLoc_XX member variables.
	...
	switch(nuMatl)
	{
		...
		case MATL_TURQUOISE: // 22
			...
			break;
		case MATL_EMIT_RED:	
			this.K_emit.push(1.0,      0.0,      0.0,      1.0);
			this.K_ambi.push(0.0,      0.0,  0.0,   0.0);
			this.K_diff.push(0.0,    0.0,  0.0,  0.0);
			this.K_spec.push(0.0, 0.0,  0.0, 0.0);   
			this.K_shiny = 1.0;
			this.K_name = "MATL_EMIT_RED";
			break;
		
		case MATL_EMIT_GRN:	
			this.K_emit.push(0.0,      1.0,      0.0,      1.0);
			this.K_ambi.push(0.0,      0.0,  0.0,   0.0);
			this.K_diff.push(0.0,    0.0,  0.0,  0.0);
			this.K_spec.push(0.0, 0.0,  0.0, 0.0);   
			this.K_shiny = 1.0;
			this.K_name = "MATL_EMIT_GRN";
			break;
			
		case MATL_EMIT_BLU:	
			this.K_emit.push(0.0,      0.0,      1.0,      1.0);
			this.K_ambi.push(0.0,      0.0,  0.0,   0.0);
			this.K_diff.push(0.0,    0.0,  0.0,  0.0);
			this.K_spec.push(0.0, 0.0,  0.0, 0.0);   
			this.K_shiny = 1.0;
			this.K_name = "MATL_EMIT_BLU";
			break;
			
		case MATL_TRUNK:	
			this.K_emit.push(0.0,      0.0,      0.0,      1.0);
			this.K_ambi.push(0.2, 0.1, 0.02, 1.0);
			this.K_diff.push(0.3,    0.15,  0.03,  0.0);
			this.K_spec.push(0.0, 0.00,  0.00, 0.0);   
			this.K_shiny = 1.0;
			this.K_name = "MATL_TRUNK";
			break;	
		
		case MATL_MIRROR:
			this.K_emit.push(0,0,0,1);
			this.K_ambi.push(0.0, 0.0, 0.0, 1.0);
			this.K_diff.push(0.0,    0.0,  0.0,  0.0);
			this.K_spec.push(0.773911, 0.773911, 0.773911, 1.0);  
			this.K_shiny = 89.6;
